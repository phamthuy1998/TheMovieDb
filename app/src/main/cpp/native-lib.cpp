...
Java_com_thuypham_ptithcm_data_util_ApiHelper_baseMovieV3Url(JNIEnv *env, jclass clazz) {
    std::string baseURL = "https://api.themoviedb.org/3/";
    return env->NewStringUTF(baseURL.c_str());
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_thuypham_ptithcm_data_util_ApiHelper_baseImageV3Url(JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_thuypham_ptithcm_data_util_ApiHelper_movieApiKey(JNIEnv *env, jclass clazz) {
