package com.thuypham.ptithcm.baseapp.data.remote.api

import com.thuypham.ptithcm.baseapp.data.remote.response.LoginResponse
...
interface MovieV3Api {
    ...
    suspend fun login(
        @Body loginParam: com.thuypham.ptithcm.baseapp.model.LoginParam,
        @Query("api_key") apiKey: String = ApiHelper.movieApiKey(),
    ): Response<LoginResponse>
}